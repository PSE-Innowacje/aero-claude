...
public static class Role
{
    ...
    public const string OsobaPlanjujaca    = "Osoba planująca";
    public const string OsobaNadzorujaca   = "Osoba nadzorująca";
    public const string Pilot              = "Pilot";

    // Grupy do atrybutów [Authorize(Roles = ...)]
    public const string PlanowanieGroup    = $"{OsobaPlanjujaca},{OsobaNadzorujaca}";
    public const string ZleceniaGroup      = $"{Pilot},{OsobaNadzorujaca}";
}

/// <summary>
/// Stałe statusów operacji i zleceń — eliminuje magic numbers.
/// </summary>
...
{
    public const int Wprowadzone          = 1;
    public const int PrzekazaneDoCkceptacji = 2;
